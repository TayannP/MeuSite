<template>
  <nav class="bg-stone-950 fixed top-0 left-0 w-full z-50 shadow-lg">
    <div class="mx-auto px-2 py-4 flex justify-between items-center">
      <!-- Logo -->
      <div class="flex items-center">
        <NuxtLink to="/">
          <img
            src="/images/tayan.svg"
            alt="Logo do site"
            width="92"
            height="92"
          />
      ...
      <div class="hidden md:flex space-x-8">
        <NuxtLink to="/" class="text-white text-1xl hover:text-sky-300"
          >Sobre mim</NuxtLink
        >
        <NuxtLink to="/projetos" class="text-white text-1xl hover:text-sky-300"
          >Projetos</NuxtLink
        >
        <NuxtLink to="/" class="text-white text-1xl hover:text-sky-300"
          >Carreira</NuxtLink
      ...
      <div class="hidden md:flex items-center space-x-4">
        <button
          class="text-white text-2xl px-6 py-2 hover:bg-gradient-to-r from-white via-gray-500 to-gray-800 text-black rounded-md text-lg font-large hover:opacity-80 transition-all duration-300 transition"
        >
          Vamos Conversar?
        </button>
      </div>
